...
text(-80.78,-5.35,'Vertical velocity (10^-4 m/s)','FontSize', 8, 'FontWeight', 'bold');
...
file.name = ['F:/roms_plots/' 'W_currents_' num2str(time) '_depth_' prof '.tif'];
img = getframe(gcf);
