...
# Version:
# Aim    : 
# URL    : This reads and calculates recruits for each spawning area
#===============================================================================
recruitment_area = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$ReleaseArea,sum) /
                 tapply(as.numeric(dataset$NumberReleased),dataset$ReleaseArea, sum)
  ...
  data_stats <-compute_recruitment_stats(as.numeric(dataset$NumberReleased),
                                         ...
                                         as.numeric(dataset$ReleaseArea))
