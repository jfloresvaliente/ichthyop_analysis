...
#=============================================================================#
recruitment_bathy = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$Bathy,sum) /
    tapply(as.numeric(dataset$NumberReleased),dataset$Bathy, sum)
