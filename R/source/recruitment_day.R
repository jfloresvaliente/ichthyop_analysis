...
# Version:
# Aim    : 
# URL    : This reads and calculates recruits for each release day (month)
#===============================================================================
recruitment_day = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$Day,sum) /
                 tapply(as.numeric(dataset$NumberReleased),dataset$Day, sum)
