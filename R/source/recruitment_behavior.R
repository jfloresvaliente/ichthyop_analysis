...
# Version:
# Aim    : 
# URL    : This reads and calculates recruits for each behavior
#===============================================================================
recruitment_behavior = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$Coast_Behavior,sum) /
                 tapply(as.numeric(dataset$NumberReleased),dataset$Coast_Behavior, sum)
  ...
  data_stats <-compute_recruitment_stats(as.numeric(dataset$NumberReleased),
                                         ...
                                         as.numeric(dataset$Coast_Behavior))
