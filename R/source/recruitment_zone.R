...
# Version:
# Aim    : 
# URL    : This reads and calculates recruits for each spawning bathymetry
#=============================================================================#
recruitment_zone = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$Zone_name,sum) /
    tapply(as.numeric(dataset$NumberReleased),dataset$Zone_name, sum)
