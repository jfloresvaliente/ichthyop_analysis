...
# Version:
# Aim    : 
# URL    : This reads and calculates recruits for each age minimum to settlement
#===============================================================================
recruitment_age = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$Age,sum) /
                 tapply(as.numeric(dataset$NumberReleased),dataset$Age, sum)
