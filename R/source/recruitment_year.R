...
# Version:
# Aim    : 
# URL    : This reads and calculates recruits for each year simulation
#===============================================================================
recruitment_year = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$Year,sum) /
                 tapply(as.numeric(dataset$NumberReleased),dataset$Year, sum)
