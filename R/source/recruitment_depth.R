...
#===============================================================================
recruitment_depth = function(dataset){
  ...
  data_factor <- 100*tapply(as.numeric(dataset$NumberRecruited),dataset$Depth,sum) /
                 tapply(as.numeric(dataset$NumberReleased),dataset$Depth, sum)
