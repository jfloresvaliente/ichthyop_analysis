...
# URL    : 
#===============================================================================
source('R/source/tracking_mean_depth.R')
start.time <- Sys.time()
...
table.files <- read.table(paste0('F:/ichthyop_output_analysis/RUN2/cfg/',winds,'_',simu, '_files.csv'), header = F, sep = ';')
...
old.path <- '/run/media/lmoecc/JORGE_NEW/ICHTHYOP/ichthyop-3.2/cfg/'  # path written in each ncdf input file
